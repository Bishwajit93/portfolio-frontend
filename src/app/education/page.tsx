...
import DeleteConfirmationModal from "@/components/experiencePageComponents/DeleteConfirmationModal"; // reused
import EducationModal from "@/components/educationPageComponents/EducationModal"; // new
import "@/styles/experienceCard.css"; // reused card styles
    ...
    <main className="min-h-screen text-white pt-[100px] pb-[60px] px-4 md:px-10">
      <div className="max-w-7xl mx-auto">
        ...
        {!addMode &&
          !selectedEducation &&
          !loading &&
          educations.length === 0 && <p>No education available.</p>}
            ...
            <ul className="space-y-6">
              {educations.map((edu) => (
                ...
                >
                  ...
                  <p>
                    <strong>Period:</strong> {edu.start_date} - {edu.end_date ?? "Present"}
                  </p>
                  <p>
